#ifndef TRINTERFACE_HPP
#define TRINTERFACE_HPP
...
static trInterface IFMSRPD0002 {"증권 우선호가 (MM/LP호가 제외)", 555, 0};
static trInterface IFMSRPD0003 {"증권 우선호가 (MM/LP호가 포함)", 795, 0};
static trInterface IFMSRPD0004 {"증권 체결", 186, 0};
static trInterface IFMSRPD0006 {"증권 체결 + 우선호가 (MM/LP호가 제외)", 648, 0};
static trInterface IFMSRPD0007 {"증권 체결 + 우선호가 (MM/LP호가 포함)", 888, 0};
static trInterface IFMSRPD0008 {"장운영TS", 68, 0};
static trInterface IFMSRPD0034 {"파생 우선호가 (우선호가 5단계)", 315, 0};
static trInterface IFMSRPD0035 {"파생 우선호가 (우선호가 10단계)", 545, 0};
static trInterface IFMSRPD0036 {"파생 우선호가 (우선호가 5단계)", 173, 0};
static trInterface IFMSRPD0037 {"파생 체결 + 우선호가 (우선호가 5단계)", 431, 0};
static trInterface IFMSRPD0038 {"파생 체결 + 우선호가 (우선호가 10단계)", 661, 0};
static trInterface IFMSRPD0041 {"파생 종목마감", 78, 0};
static trInterface IFMSBTD0001 {"증권 종목정보", 620, 0};
static trInterface IFMSBTD0004 {"ELW 종목정보", 930, 0};
static trInterface IFMSBTD0010 {"종목이벤트 정보", 48, 0};
static trInterface IFMSBTD0011 {"MM/LP 정보", 197, 0};
static trInterface IFMSBTD0022 {"파생 종목정보", 1318, 0};
static trInterface IFMSBTD0025 {"주식파생 조정내역", 156, 0};
static trInterface IFMSSTD0006 {"거래상위 5개 회원 통계", 414, 0};

// 버릴 수 없는 TR 목록 및 각 TR의 사이즈
static QMap<QString, trInterface> mapTrCode {
